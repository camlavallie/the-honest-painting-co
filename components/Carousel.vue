...
export default {
   head () {
      ...
      meta: [
        { hid: 'description', name: 'description', content: 'The Honest Painting Co offers excellent painting for Geelong and the surrounding area. We specialise in interior and exterior painting, either commercial or domestic. You can be sure to get competitive painting prices done with excellence.' },
